...
<head>
    ...
    <title>Generate Test Report - <?= $HEALTHCARENAME ?></title>

    <link rel="stylesheet" href="<?= CSS_PATH ?>sb-admin-2.css" type="text/css" />
    <link rel="stylesheet" href="<?= CSS_PATH ?>lab-section.css" type="text/css" />
    <link rel="stylesheet" href="<?= CSS_PATH ?>borders.css" type="text/css" />
