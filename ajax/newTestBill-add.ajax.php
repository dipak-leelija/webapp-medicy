            ...
            <form id="patientForm" class="form-card " action="" method="post">
                <div class="row justify-content-between text-left">
                    <div class="form-floating col-sm-6 mt-3">
                        <input type="text" class="form-control newbillInput" id="patientName" name="patientName" placeholder="" Required autocomplete="off">
                        <label for="patientName">Patient Name<span class="text-danger"> *</span></label>
                    </div>
                    <div class="form-floating col-sm-6 mt-3">
                        <input type="text" class="form-control newbillInput" id="patientGurdianName" name="patientGurdianName" placeholder="" required autocomplete="off">
                ...
                <div class="row justify-content-between text-left">
                    <div class="form-floating col-sm-6 mt-3">
                        <input type="number" class="form-control newbillInput" id="patientAge" name="patientAge" onfocusout="checkAge(this)" placeholder="" required autocomplete="off">
                ...
                <div class="row justify-content-between text-left">
                    <?php if (!$test) : ?>
                        <div class="form-floating col-sm-6 mt-3">
                            <input type="number" class="form-control newbillInput" id="patientWeight" name="patientWeight" onfocusout="checkWeight(this)" placeholder="" required autocomplete="off">
                            <label for="patientWeight">Weight<span class="text-danger"> *</span></label>
                        </div>
                    <?php endif; ?>
                    <div class="form-floating col-sm-6 mt-3">
                        <input type="tel" class="form-control newbillInput" id="patientPhoneNumber" name="patientPhoneNumber" onchange="checkContactNo(this)" placeholder="" required autocomplete="off" maxlength="10">
                        <label for="patientPhoneNumber">Phone
                            number<span class="text-danger"> *</span></label>
                        <div class='text-danger fs-6' id="pMsg"></div>
                    </div>
                    <div class="form-floating col-sm-6 mt-3">
                        <input type="date" class="form-control newbillInput" id="appointmentDate" name="appointmentDate" placeholder="" value="<?php print(date("Y-m-d")) ?>" required autocomplete="off">
                    ...
                    <?php if (!$test) : ?>
                        ...
                        <div class="form-floating col-sm-6 mt-3">
                            <input type="email" class="form-control newbillInput" id="email" name="patientEmail" placeholder="" autocomplete="off" onchange="checkMail(this)">
                ...
                <div class="row justify-content-between text-left">
                    <div class="form-floating col-sm-6 mt-3">
                        <input type="text" class="form-control newbillInput" id="patientAddress1" name="patientAddress1" placeholder="" required autocomplete="off">
                    ...
                    <?php if (!$test) : ?>
                        <div class="form-floating col-sm-6 mt-3">
                            <input type="text" class="form-control newbillInput" id="patientPS" name="patientPS" placeholder="" required autocomplete="off">
                ...
                <div class="row justify-content-between text-left">
                    ...
                    <?php endif; ?>
                    <div class="form-floating col-sm-6 mt-3">
                        <input type="text" class="form-control newbillInput" id="patientDist" name="patientDist" Value="<?= $district; ?>" placeholder="" required autocomplete="off">
                        <label for="patientDist">District<span class="text-danger"> *</span></label>
                    </div>
                    <?php if (!$test) : ?>
                        <div class="form-floating col-sm-6 mt-3">
                            <input type="number" class="form-control newbillInput" id="patientPIN" name="patientPIN" required onfocusout="checkPin(this)" Value="<?= $pin ?>" placeholder="" autocomplete="off">
                ...
                <div class="row justify-content-end mt-3">
                    <div class="form-group col-sm-4">
                        <button type="submit" name="submit" id="submitBtn" class="btn-block btn-primary">Submit</button>
