...
if ($showProducts->status) {
    ...
    foreach ($showProducts as $showProducts) {
        ...
        echo "<div class='p-1 border-bottom list'>
                <div class='d-flex'>
                    <div class='col-sm-9' id='$showProducts->product_id' prodReqStatus='$prodReqStatus' oldProdReqFlag='$oldProdReqFlag' editRequestFlag='$editRequestFlag' table='$table' onclick='searchProduct(this)'>
