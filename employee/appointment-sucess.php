<?php
  ...
  if(isset($_COOKIE['appointmentId'])) {
    $generatedAppointmentId = $_COOKIE['appointmentId'];
    $set = true;
  }else{
    $set = false;
  }
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/sucessPageStyle.css">

    <!--Only for demo purpose - no need to add.-->

    <link rel="stylesheet" href="assets/css/sucessPageDemo.css">
