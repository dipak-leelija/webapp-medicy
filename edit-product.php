        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4 h-100">
                        ...
                        <form action="<?= htmlspecialchars(CURRENT_URL); ?>" method="post"
                            ...
                            <div class="d-flex">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input class="c-inp w-100 p-1" id="product-composition1"
                                                name="product-composition1" placeholder="Product Composition"
                                                value="<?= $comp1 ?>" required>
                                        </div>
                                        <div class="col-md-12 mt-2">
                                            <input class="c-inp w-100 p-1" id="product-composition2"
                                                name="product-composition2" placeholder="Product Composition"
                                                value="<?= $comp2 ?>">
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mt-3">
                                            <input type="number" class="c-inp p-1 w-100" name="quantity"
                                                id="quantity" placeholder="Enter Quantity" value="<?= $qty ?>">
                                        </div>
                                        ...
                                        <div class="col-md-4 mt-3">
                                            ...
                                            <select class="c-inp p-1 w-100" name="packaging-type" id="packaging-type">
                                                ...
                                                <?php
                                                    ...
                                                    ?>
                                                <option <?= $packagingType == $packType['id'] ? 'selected' : ''; ?> 
                                                    value="<?= $packType['id'] ?>">
                                                    <?= $packType['unit_name'] ?>
                                                </option>';
                                                <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" class="c-inp w-100 p-1" name="mrp" id="mrp"
                                                placeholder="Enter MRP" onkeyup="getMarginMrp(this.value)" step="0.01"
                                                value="<?= $mrp; ?>">
                                        </div>
                                    ...
                                    <div class="col-md-12 mt-4">
                                        <textarea class="c-inp w-100 p-1" name="product-description"
                                            id="product-description" placeholder="Product Description" cols="30"
                                            rows="3"><?= $dsc ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <button class="btn btn-primary" name="update-product" id="update-btn"
                    ...
                    <input type="" id="imgid" name="imgid"
                        value="<?php echo isset($image[0]['product_id'])? $image[0]['product_id'] : ''; ?>"
                        class="d-none">
