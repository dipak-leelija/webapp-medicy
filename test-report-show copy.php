...
<body>
    ...
    <div class="header-area">
        ...
        <hr style="background:black; height: 4px; width:90%; margin: auto;">
    </div>
        ...
        <table>
            ...
            ?>
                        <tr>
                            ...
                            <td class="test-value"><?= $testData[$i] ?></td>
                        </tr>
            <?php
                    }
                }
    ...
    <div class="footer-area">
        <div style="width: 90%; margin: auto;">
            <p style="text-align: left; margin-bottom: 0;">Reference values are obtained from the literature provided with reagent kit.</p>
            <hr style="color:black;background:black; height:4px; margin: auto">
        </div>
