...
if(isset($_POST['submit']))
{
         ...
         $from = $_POST['email'];
         $header = "From:$from \r\n";
         $header .= "Cc:dipakmajumdar.leelija@gmail.com \r\n";
         ...
         $add = new insert();
         $addEmp= $add-> adddata( $name,$email,$subject,$message);
...
<body class="clinic_version">
    ...
    <!-- Javascript Files for Contact Us Details Verification -->
    <script src="../../contact-us-js/js/jquery.min.js"></script>
    <script src="js/popper.js"></script>
    <script src="js/bootstrap.min.js"></script>
    <script src="js/jquery.validate.min.js"></script>
    <script src="js/main.js"></script>
<!-- php add into database ##############################################-->
