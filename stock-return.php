                        ...
                        ?>
                            ...
                            <div id="hiddenDiv" class="hidden" style="display: none;">
                                <div id=" date-range-container">
                                    ...
                                    <button class="btn btn-sm btn-primary" id="added_on" value="CR"
                                        onclick="getDates(this.id, this.value)" style="height: 2rem;">Find</button>
                                </div>
                            </div>
                                                ...
                                                <g>
                                                    <g>
                                                        <path style="fill:#98CCFD;"
                                                            d="M24.405,20.771c0.646-1.188,0.949-2.402,0.906-3.631c-0.101-2.912-2.115-5.258-3.787-6.713    l-0.352-0.307L18.5,12.793V4.5h8.293l-2.32,2.32l0.379,0.353c1.6,1.493,3.506,3.803,3.506,6.327    C28.357,16.728,26.229,19.224,24.405,20.771z" />
                                                    </g>
                                                    <g>
                                                        <path style="fill:#4788C7;"
                                                            d="M25.586,5l-1.1,1.1l-0.732,0.732l0.756,0.706c1.25,1.167,3.347,3.493,3.347,5.962    c0,2.132-0.997,3.935-2.195,5.332c0.119-0.565,0.169-1.136,0.149-1.71c-0.107-3.092-2.212-5.553-3.959-7.073l-0.704-0.612    l-0.66,0.66L19,11.586V5H25.586 M28,4H18v10l3.196-3.196c2.537,2.208,6.227,6.844,0.875,12.196c0,0,6.786-3.5,6.786-9.5    c0-2.749-2.079-5.213-3.664-6.693L28,4L28,4z" />
                                                    </g>
                                                </g>
                                                <path
                                                    style="fill:none;stroke:#4788C7;stroke-linecap:round;stroke-miterlimit:10;"
                                                    d="M37.368,11.682L33.9,24.395  c-0.177,0.65-0.772,1.105-1.447,1.105H11.911" />
                                                <g>
                                                    <circle style="fill:#DFF0FE;" cx="2" cy="3" r="1.5" />
                                                    <path style="fill:#4788C7;"
                                                        d="M2,2c0.551,0,1,0.449,1,1S2.551,4,2,4S1,3.551,1,3S1.449,2,2,2 M2,1C0.895,1,0,1.895,0,3   s0.895,2,2,2s2-0.895,2-2S3.105,1,2,1L2,1z" />
                                                </g>
                                                <g>
                                                    <circle style="fill:#98CCFD;" cx="30.5" cy="36.5" r="2" />
                                                    <path style="fill:#4788C7;"
                                                        d="M30.5,35c0.827,0,1.5,0.673,1.5,1.5S31.327,38,30.5,38S29,37.327,29,36.5S29.673,35,30.5,35    M30.5,34c-1.381,0-2.5,1.119-2.5,2.5s1.119,2.5,2.5,2.5s2.5-1.119,2.5-2.5S31.881,34,30.5,34L30.5,34z" />
                                                </g>
                                                <g>
                                                    <circle style="fill:#98CCFD;" cx="17.5" cy="36.5" r="2" />
                                                    <path style="fill:#4788C7;"
                                                        d="M17.5,35c0.827,0,1.5,0.673,1.5,1.5S18.327,38,17.5,38S16,37.327,16,36.5S16.673,35,17.5,35    M17.5,34c-1.381,0-2.5,1.119-2.5,2.5s1.119,2.5,2.5,2.5s2.5-1.119,2.5-2.5S18.881,34,17.5,34L17.5,34z" />
                                                </g>
                                                <path
                                                    style="fill:none;stroke:#4788C7;stroke-linecap:round;stroke-miterlimit:10;"
                                                    d="M2,1.5h2.119  c2.093,0,3.882,1.505,4.241,3.567l4.498,25.866c0.359,2.062,2.148,3.567,4.241,3.567H34.5" />
                                            </svg>
                                        </div>
