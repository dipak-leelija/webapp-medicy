                                                ...
                                                <div class="col-12 d-flex mt-5">
                                                    <div class="col-md-7">
                                                        ...
                                                        <div class="row d-flex">
                                                            <div class="col-md-6 form-group">
                                                                <input type="text" class=" med-input" id="email1"
                                                                    name="email1" maxlength="100" value="<?= $email; ?>"
                                                                    required>
                                                            ...
                                                            <div class="col-md-6 form-group">
                                                                <input type="number" class=" med-input"
                                                                    id="mobile-number1" name="mobile-number1"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 form-group">
                                                                <input type="text" class=" med-input" id="title1"
                                                                    name="title1" required>
                                                                <label class="med-label" style="margin-left:10px;"
                                                                    for="title1">Message Title</label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="col-md-12 form-group card med-card"
                                                            style="border: 1px solid #ced4da; padding: 8px; height: 14rem; position: relative;">
                                                        ...
                                                        <i class="fas fa-upload text-primary" id="upload-document1"
                                                            style="position: absolute; left: 18rem; bottom: 30px; cursor: pointer;"
                                                            onclick="document.getElementById('fileInput1').click();"></i>
                                                        <input type="file" class="d-none" name="fileInput1"
                                                            id="fileInput1"
                                            ...
                                            <form action="_config\form-submission\ticket-query-submit.php"
                                                ...
                                                <div class="col-12 d-flex mt-5">
                                                    <div class="col-md-7">
                                                        ...
                                                        <div class="row d-flex">
                                                            <div class="col-md-6 form-group">
                                                                <input type="text" class=" med-input" id="email2"
                                                                    name="email2" maxlength="100" value="<?= $email; ?>"
                                                                    required>
                                                                <label class="med-label" style="margin-left:10px;"
                                                                    for="emial">Email id</label>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 form-group">
                                                                <input type="number" class=" med-input"
                                                                    id="mobile-number2" name="mobile-number2"
                                                                    maxlength="10" max="9999999999"
                                                                    value="<?= $phone; ?>" required>
                                                                <label class="med-label" for="mobile-number">Contact
                                                                    Number</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 form-group">
                                                                <input type="text" class=" med-input" id="title2"
                                                                    name="title2" required>
                                                                <label class="med-label" style="margin-left:10px;"
                                                                    for="title2">Message Title</label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <input type="file" class="d-none" name="fileInput2"
                                                            id="fileInput2"
