                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-6">
                                            ...
                                            <input type="text" class="upr-inp" name="ptr" id="ptr"
                                                onkeyup="getBillAmount()" readonly>
                                        </div>
                                    </div>
                                    <!-- first row end  -->
                                    <!-- second row  -->
                        ...
                        <form action="_config\form-submission\stock-return.php" method="post">
                                    ...
                                    <table class="table item-table">
                                        ...
                                        <tbody id="dataBody">
                                            ...
                                            <tr id="<?php echo 'table-row-'.$slno;?>">
                                                <td style="color: red;" <i class="fas fa-trash pt-3 "
                                                    onclick="deleteData(<?php echo $slno.','.$bill['return_qty'].','. $bill['refund_amount'].','.$bill['refund_amount']; ?>)">
                                                    </i></td>
                                                <td class="p-0 pt-3">
                                                    <input class="col table-data w-12r" type="text" name="productName[]"
                                                        value="<?php echo $bill['product_id'];?>" readonly
                                                        style="text-align: start;">
                                                    <input class="col table-data w-12r" type="text" name="productId[]"
                                                        value="<?php echo $bill['product_id'];?>" readonly
                                                        style="text-align: start;" hidden>
                                                </td>
                                                <td class="p-0 pt-3">
                                                    <input class="col table-data w-6r" type="text" name="batchNo[]"
                                                        value="<?php echo $bill['batch_no']; ?>" readonly>
                                                </td>
                                                <td class="p-0 pt-3">
                                                    <input class="col table-data w-5r" type="text" name="expDate[]"
                                                        value="<?php echo $bill['exp_date']; ?>" readonly>
                                                </td>
                                                <td class="p-0 pt-3">
                                                    <input class="col table-data w-5r" type="text" name="setof[]"
                                                        value="<?php echo $bill['unit']; ?>" readonly>
                                                </td>
                                                <td class="p-0 pt-3">
                                                    <input class="col table-data w-5r" type="text" name="purchasedQty[]"
                                                        value="<?php echo $bill['purchase_qty']; ?>" readonly>
                                                </td>
                                                <td class="p-0 pt-3">
                                                    <input class="col table-data w-5r" type="text" name="freeQty[]"
                                                        value="<?php echo $bill['free_qty']; ?>" readonly>
                                                </td>
                                                <td class="p-0 pt-3">
                                                    <input class="col table-data w-5r" type="text" name="mrp[]"
                                                        value="<?php echo $bill['mrp']; ?>" readonly>
                                                </td>
                                                <td class="p-0 pt-3">
                                                    <input class="col table-data w-6r" type="text" name="ptr[]"
                                                        value="<?php echo $bill['ptr']; ?>" readonly>
                                                </td>
                                                <td class="p-0 pt-3">
                                                    <input class="col table-data w-6r" type="text"
                                                        name="purchase-amount[]"
                                                        value="<?php echo $bill['purchase_amount']; ?>" readonly>
                                                </td>
                                                <td class="p-0 ps-1 pt-3">
                                                    <input class="col table-data w-4r" type="text" name="gst[]"
                                                        value="<?php echo $bill['gst']; ?>" readonly>
                                                </td>
                                                <td class="p-0 pt-3">
                                                    <input class="col table-data w-8r" type="text" name="return-qty[]"
                                                        value="<?php echo $bill['return_qty']; ?>" readonly>
                                                </td>
                                                <td class=" amnt-td p-0 pt-3">
                                                    <input class="col table-data W-6r" type="text"
                                                        name="refund-amount[]"
                                                        value="<?php echo $bill['refund_amount']; ?>" readonly>
                                                </td>
                                            </tr>
                            ...
                            <div class="  p-3 m-2  font-weight-bold text-light purchase-items-summary rounded">
                                <div class="row ">
                                    ...
                                    <div class="col-md-3 col-6 mb-3 d-flex justify-content-start">
                                        <p>Return Date : <input class="summary-inp w-6r" name="return-date"
                                                id="return-date" type="text"
                                                value="<?php $today = date("d-m-Y"); echo $today;?>" readonly>
                                        </p>
                                    </div>

                                    <div class="col-md-3 col-6 mb-3  d-flex justify-content-start">
                                        <p>Items : <input class="summary-inp w-6r" name="items-qty" id="items-qty"
                                                type="text" value="0" readonly></p>
                                    </div>

                                    <div class="col-md-3 col-6 mb-2 d-flex justify-content-start">
                                        <p>Refund Mode : <input class="summary-inp w-6r" name="refund-mode"
