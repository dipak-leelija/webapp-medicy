                                        ...
                                        <div class="col-md-3   b-right date">
                                            <div class="row mt-3 mb-3">
                                                ...
                                                <div class="col-md-9 col-10 ">
                                                    ...
                                                    <input type="date" class="bill-date" id="bill-date" value="<?php echo $billdate; ?>" onchange="getDate(this.value)">
                                        ...
                                        <div class="col-md-3  b-right doctor">
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-9 col-10">
                                                    ...
                                                    <input class="customer-search" list="datalistOptions" id="doctor-name" value="<?php echo $reffby; ?>" placeholder="Doctor Name" onkeyup="getDoctor(this.value)">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table item-table">
                                                    ...
                                                    <?php echo $slno . ',';
                                                        ...
                                                        echo $detail['gst_amount'] . ',';
                                                        if ($detail['qty'] > 0) {
                                                            echo $detail['mrp'] * $detail['qty'] . ',';
                                                        } else {
                                                            echo $detail['mrp'] * $detail['loosely_count'] . ',';
                                                        }
                                                        echo $detail['amount']; ?>)"></i>
                                                        </td> -->
                                                                <td>
                                                                    <input class="summary-product" type="text" name="product-name[]" value="<?php echo $Product['0']['name']; ?>" readonly>
                                                                    <input type="text" name="product-id[]" value="<?php echo $detail['item_id']; ?>" hidden>
                                                                    <input type="text" name="Manuf[]" value="<?php echo $Manuf[0]['name']; ?>" hidden>
                                                                ...
                                                                <td>
                                                                    <input class="summary-items" type="text" name="mrp[]" value="<?php echo $detail['mrp']; ?>" readonly>
                                                                </td>
                                                                <td>
                                                                    <input class="summary-items" type="text" name="qty[]" value="<?php
                                                                                                                                    if ($detail['qty'] > 0) {
                                                                                                                                        ...
                                                                                                                                        $suffix = "(L)";
                                                                                                                                        echo $detail['loosely_count'].$suffix;
                                                                                                                                    }
                                                                                                                                    ?>" readonly>
                                                                    <input type="text" id="qty-types" name="qty-types[]" value="<?php echo $detail['weatage']; ?>" hidden>
                                                                ...
                                                                <td>
                                                                    <input class="summary-items" type="text" name="dPrice[]" value="<?php echo $detail['mrp'] - ($detail['disc'] / 100 * $detail['mrp']); ?>" readonly>
                                                                </td>
                                                                <td>
                                                                    <input class="summary-items" type="text" name="gst[]" value="<?php echo $detail['gst']; ?>" readonly>
                                                                    <input type="text" name="netGst[]" value="<?php echo $detail['gst_amount']; ?>" hidden>
                                            ...
                                            <div class="listed-sumary p-3 text-light rounded">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 col-8  mb-3 b-right d-flex">
                                                        ...
                                                        <input class="sumary-inp" type="text" id="final-doctor-name" name="doctor-name" value="<?php echo $reffby; ?>" readonly>
                                                    </div>
