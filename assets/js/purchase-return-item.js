...
const getRefund = (returnQty) => {
  ...
  if (returnQty > parseInt(currentPurchaseQty)) {
    ...
    if (returnQty != "") {
      ...
      xmlhttp.open("GET", basePriceURL, false);
      xmlhttp.send(null);
      let amount = xmlhttp.responseText;
...
function addData() {
  ...
  const dataRow = `
    <tr id="table-row-${slControl}">
                        ...
                        <td id="row-${slControl}-col-2" style="font-size:.8rem ; padding-top:1.5rem"scope="row">${slno}</td>
                        <td class="pt-3" id="row-${slControl}-col-4">
                            <input class="td-item" type="text" name="productName[]" value="${
                              productName.value
                            }" readonly>
                            <input class="td-item" type="text" name="setof[]" value="${
                              weatage.value
                            }" readonly>
                            <input class="d-none" type="text" name="productId[]" value="${
                              productId.value
                            }" readonly>
                            <input class="d-none" type="number" name="purchasedQty[]" value="${
                              purchasedQty.value
                            }" readonly>
                            <input class="d-none" type="number" name="free-qty[]" value="${
                              freeQty.value
                            }" readonly>
                            <input class="d-none" type="text" name="stok-in-details-id[]" value="${
                              stokInDetailsId.value
                            }" readonly>
                            <input class="d-none" type="text" name="distBillNo[]" value="${
                              billNumber.value
                            }" readonly>
                        </td>
                        <td class="pt-3" id="row-${slControl}-col-5">
                            <input class="td-input" type="text" name="batchNo[]" value="${
                              batchNumber.value
                            }" readonly>
                        </td>
                        <td class="pt-3" id="row-${slControl}-col-6">
                            <input class="td-input" type="text" name="expDate[]" value="${
                              expDate.value
                            }" readonly>
                        </td>
                        <td class="pt-3" id="row-${slControl}-col-10">
                            <input class="td-input" type="text" name="mrp[]" value="${
                              mrp.value
                            }" readonly>
                        </td>
                        <td class="pt-3" id="row-${slControl}-col-11">
                            <input class="td-input" type="text" name="ptr[]" value="${
                              ptr.value
                            }" readonly>
                        </td>
                        <td class="pt-3"id="row-${slControl}-col-12">
                            <input class="td-input" type="text" name="disc-percent[]" value="${
                              discount.value
                            }%" readonly>
                        </td>
                        <td class="ps-1 pt-3" id="row-${slControl}-col-13">
                            <input class="td-input" type="text" name="gst[]" value="${
                              GST.value
                            }%" readonly>
                        </td>
                        <td class="pt-3" id="row-${slControl}-col-14">
                        ...
                        <td class="amnt-td pt-3" id="row-${slControl}-col-16">
                            <input class="td-input" type="text" name="refund-amount[]" value="${
                              refundAmount.value
                            }" readonly>
                        </td>
                    </tr>`;
