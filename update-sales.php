...
?>
    ...
    <head>
        ...
        <title><?= '#' . $billId . ' - ' . $HEALTHCARENAME ?></title>

        <link rel="stylesheet" href="<?= CSS_PATH ?>sb-admin-2.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="<?= CSS_PATH ?>update-sales.css" type="text/css" />
    ...
    <body id="page-top">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-3 col-6 mb-4">
                                                        <div class="row">
                                                            <label for="" style="margin-top: 6px;">Purchased Cost:</label>
                                                        </div>
                                                        <div class="row">
                                                            <input class="d-none sale-inp" type="any" id="ptr" style="border-width: 0px;" readonly>
                                                            <input class="d-none sale-inp" type="any" id="per-item-purchased-cost" style="border-width: 0px;" readonly>
        ...
        <?php echo '<script>const LOOSEUNITS = ' . json_encode(LOOSEUNITS) . ';</script>'; ?>
