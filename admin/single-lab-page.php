            ...
            <div id="content">
                ...
                <section class="main_section">
                    ...
                    <div class="row mx-2" style="background-color:#4e73df;">
                        ...
                        <div class="col-1">
                            <label class="text-white text-center m-0 py-2 font-weight-bold" style="background-color: #4e73df;" onclick="openAddNewTestModal()">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addTestDataModelLabel">Add New Test Data</h5>
