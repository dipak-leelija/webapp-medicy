...
// ================ employee detials ===================
$empCol = 'admin_id';
$employeeDetails = $Employees->selectEmpByCol($empCol);
...
if (isset($_GET['search'])) {
    ...
    if ($_GET['search'] == 'refered_doctor') {
        ...
        $labBillDisplay = $LabBilling->labBillFilter($col, $doctorID);
    }
    ...
    if ($_GET['search'] == 'added_by') {
        ...
        $doctorID = $_GET['searchKey'];
        // print_r($doctorID);
        // $labBillDisplay = $LabBilling->labBillFilter($doctorID);
        ///...... Lab Bill Filter BY AdminID ...........///
        $labBillDisplay = $LabBilling->labBillFilterByAdminID($doctorID);
    }

    if ($_GET['search'] == 'appointment-search') {
        $match = $_GET['searchKey'];

        $labBillDisplay = $LabBilling->labBillFilter('search', $match);
    }
