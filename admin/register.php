    ...
    if($checkUser > 0){
        ...
        if($checkMail > 0){
            ...
            if($password == $cpassword){
                ...
                $register = $admin->registration($Fname, $Lname, $username, $password, $email, $mobNo, $address, $city);
                if ($register) {
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block "><img style="width:100%;" src="img/welcome-admin.jpg"
                            alt=""></div>
                    <div class="col-lg-7">
                        <div class="p-5">
