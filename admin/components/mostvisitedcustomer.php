    ...
    <div class="d-flex justify-content-end px-2">
        ...
        <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <button class="dropdown-item" type="button" id="lst7" onclick="mostCustomer(this.id)">Last 7 Days</button>
                <button class="dropdown-item" type="button" id="lst30" onclick="mostCustomer(this.id)">Last 30 DAYS</button>
                <button class="dropdown-item" type="button" id="lstdt" onclick="mostCustomer(this.id)">By Date</button>
            </div>
        </div>
    </div>
