    ...
    <div id="about" class="section wow fadeIn">
        <div class="container">
            <div class="heading">
                ...
                <h2>Medicy Health Care Diagnostic</h2>
            </div>
            <!-- end title -->
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">
                        ...
                        <a href="lab-tests.php" data-scroll class="btn btn-light btn-radius btn-brd grd1 effect-1">Learn
                            More</a>
                    </div>
                    <!-- end messagebox -->
                </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                           <div class="wow1">
                            <img src="images/clinic_01.jpg" alt="" class="img-responsive"></div>
                        </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                           <div class="wow1">
                            <img src="images/clinic_02.jpg" alt="" class="img-responsive"></div>
                        </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                           <div class="wow1">
                            <img src="images/clinic_03.jpg" alt="" class="img-responsive"></div>
                        </div>
                        <h3>Pharmacy</h3>
                    </div>
                    <!-- end service -->
                    ...
                    <div class="inner-services">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <div class="serv">
                                ...
                                <h4>Pharmacy</h4>
                                <p>Get discounts on all essential products at Medicy Health Care pharmacy.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <div class="serv">
                                ...
                                <h4>Medical Tests</h4>
                                <p>Medical tests are made by high quality Machines and deliver accurate reports.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <div class="serv">
                                ...
                                <p>You can avail treatment at a cheap cost from our expertised Doctors.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <div class="serv">
                                ...
                                <p>Online appointments can be made 24x7.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <div class="serv">
                                ...
                                <p>Order medicines online and get quick home delivery at reasonable price.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <div class="serv">
                                ...
                                <h4>Covid Care</h4>
                                <p>Covid patients will get proper treatment and medications for a quick recovery.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="appointment-form">
                        ...
                        <div class="form">
                            <div class="appbookbtn">
                                ...
                                <a href="login.php">Book Your Appointment</a>
                            </div>
                        </div>
                    </div>
                </div>
