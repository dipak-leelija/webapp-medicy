        ...
        <div class="py-5">
            ...
            <form class="user" action="<?= URL ?>cheakout/" method="post">
                            ...
                            <div class="card my-4">
                                <div class="card-body">
                                        ...
                                        <?php foreach ($features as $feature) : ?>
                                            <?php if ($feature->plan_id == $eachPlans->id) : ?>
                                                <div class="d-flex justify-content-between">
                                                    <p class="card-text"><?= htmlspecialchars($feature->features, ENT_QUOTES, 'UTF-8') ?></p>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <input id="plan-<?= $eachPlans->id ?>" class="plan-input" type="radio" name="plan" value="<?= $eachPlans->id ?>">
                ...
                <div class="d-flex justify-content-center">
                    <button id='continue-button' class="btn btn-primary rounded-pill font-weight-bold w-75" type="submit" disabled>Continue</button>
                </div>
            </form>
        </div>
