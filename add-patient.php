                                ...
                                <form class="form-card" action="<?= $currentURL ?>" method="post">
                                    ...
                                    <?php if (!$test) : ?>
                                        <div class="row justify-content-between text-left">
                                            ...
                                            <h3 class="text-center mb-4 mt-5" id="no-doc" style="color: red; display: none">ADD DOCTOR FIRST</h5>

                                                <?php
                                                if ($showDoctors->status) {
                                                ?>
                                                    <div class="form-group col-sm-12 flex-column d-flex" id="doc-list">
