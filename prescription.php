    ...
    <div class="custom-body">
        ...
        <div class=" footer w-100" style="margin-bottom:0px;position:static;">
            <div class="row border border-primary pt-2 pb-0">
                ...
                <div class="col-md-4 custom-width-email mb-0 text-end">
                    <ul style="margin-bottom: 8px;padding-left:0;">
                ...
                <div class="col-md-4 custom-width-number mb-0 text-end">
                    <ul style="margin-bottom: 8px">
                        <li class="list-unstyled"><img id="number-box" class="pe-2"
                                src="<?= IMG_PATH ?>icons/call-logo.png" alt="Contact"
                                style="width:28px; height:20px;" /><span><?= $healthCarePhno ?></span>
                        </li>
                    </ul>
                </div>
            </div>
...
<!-- <body>
    ...
    <div style="" class="card shadow-none">
        <div class="hospitslDetails mb-0">
            <div class="row">
                <div class="col-2 headerHospitalLogo">
        ...
        <div class=" footer " style="margin-bottom:0px;position:static;">
