        ...
        <div class=" footer ">
            <div class="row border border-primary pt-2 pb-0 d-flex justify-content-between">
                ...
                <div class="col-md-4 custom-width-number mb-0">
                    <ul style="margin-bottom: 8px">
                        <li class="list-unstyled"><img id="number-box" class="pe-2" src="<?php echo LOCAL_DIR ?>employee/partials/call-logo.png" alt="Contact" style="width:28px; height:20px;" /><span><?php echo $appointmentNumber . ', ' . $hospitalPhno ?></span>
                        </li>
                    </ul>
                </div>
            </div>
