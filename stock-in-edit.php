...
<head>
    ...
    <link href="<?= CSS_PATH ?>custom-dropdown.css" rel="stylesheet">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row mt-4 mb-2">
                                                ...
                                                <div class="d-none col-md-4 mt-2">
                                                    <label class="mb-0" for="purchase-details-id">Stock In details
                                                        Id</label>
                                                    <input type="text" class="upr-inp" name="purchase-id"
                                                        id="purchase-id" value="" readonly>
                                                </div>
                                            ...
                                            <input type="text" class="upr-inp" id="dist-bill-no" value="" readonly>
                                                ...
                                                <div class="col-md-12 ">
                                                    ...
                                                    <input class="upr-inp mt-2" list="datalistOptions" id="product-name"
                                                        ...
                                                        onkeyup="searchItem(this.value);" onkeydown="chekForm()">
                                            ...
                                            <div class="row">
                                                ...
                                                <option value="" disabled selected>Select </option>
                                                    ...
                                                    <input class="upr-inp" id="manufacturer-id" name="manufacturer-id"
                                                        value="">
                                                    <input class="upr-inp" id="manufacturer-name"
                                                ...
                                                <div class="col-md-12 ">
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-sm-6 col-md-3 mt-2 ">
                                                            ...
                                                            <input type="text" class="upr-inp" id="unit" value=""
                                                                readonly>
                                                        </div>

                                                        <div class="col-sm-6 col-md-3 mt-2 ">
                                                            <label class="mb-0" for="packaging-in">Packaging-in</label>
                                                            <input type="text" class="upr-inp" id="packaging-in"
                                                                readonly>
                                                        </div>
                                                        <div class="col-sm-6 col-md-3 mt-2 ">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-sm-4 col-md-4 mt-2">
                                                    ...
                                                    <input type="text" class="upr-inp" name="ptr" id="ptr"
                                            ...
                                            <div class="col-sm-6 col-md-3 mt-2">
                                                ...
                                                <div class="d-none col-sm-6 col-md-6 mt-2">
                                                    ...
                                                    <input type="text" class="upr-inp" id="packaging-type-edit"
                                                        readonly>
                                                ...
                                                <div class="col-sm-4 col-md-4 mt-2">
                                                    ...
                                                    <input type="number" class="upr-inp" name="discount" id="discount"
                                                        placeholder="Discount Percentage" value="0"
                                                        onkeyup="getBillAmount()">
                                                </div>
                                                ...
                                                <div class="d-none col-md-4 mt-2">
                                                    ...
                                                    <input type="number" class="upr-inp" name="crntGstAmnt"
                                                        id="crntGstAmnt">
                                                </div>
                                                ...
                                                <div class="d-none col-md-4 mt-2">
                                                    ...
                                                    <input type="any" class="upr-inp" name="temp-bill-amount"
                                                        id="temp-bill-amount">
                                                </div>
                                            </div>
                                            <!--/End Quantity Row  -->
                                    ...
                                    <table class="table item-table" id="item-table" style="width: 100%;">
                                        ...
                                        <tbody id="dataBody" style="cursor: pointer;">
                                            ...
                                            <tr id="<?php echo 'table-row-' . $slno; ?>">
                                                ...
                                                <td style="color: red; width:1rem"><i class="fas fa-trash "
                                                        style="padding-top: .5rem;"
                                                        onclick="deleteData(<?php echo $slno . ',' . intval($detail['qty']) + intval($detail['free_qty']) . ',' . $detail['gst_amount'] . ',' . $detail['amount'] ?>)">
                                                    </i>
                                                </td>

                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')"
                                                    style="width: 1rem; padding-top: 1rem"><?php echo $slno ?>
                                                </td>

                                                <td class="d-none p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')">
                                                    <input class="col table-data w-6r" type="text" name="purchaseId[]"
                                                        id="purchaseId" value="<?php echo $detail['id'] ?>" readonly>
                                                </td>

                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')">
                                                    <input class="col table-data w-9r" type="text" name="productNm[]"
                                                        value="<?php echo $product[0]['name'] ?>" readonly
                                                        style="text-align: start; font-size: 0.65rem;">
                                                    <input class="d-none col table-data w-9r" type="text"
                                                        name="productId[]" value="<?php echo $detail['product_id'] ?>"
                                                        readonly>
                                                </td>

                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')">
                                                    <input class="col table-data w-6r" type="text" name="batchNo[]"
                                                        value="<?php echo $detail['batch_no'] ?>" readonly
                                                        style="font-size: 0.65rem; text-align:start;">
                                                </td>

                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')">
                                                    <input class="col table-data w-4r" type="text"
                                                        style="font-size: 0.65rem; text-align:start;" name="mfdDate[]"
                                                        id="mfdDate" value="<?php echo $detail['mfd_date'] ?>" readonly>
                                                </td>

                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')">
                                                    <input class="col table-data w-4r" type="text" name="expDate[]"
                                                ...
                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')">
                                                    <input class="col table-data w-4r" type="text" name="setof[]"
                                                        value="<?php echo $detail['weightage'] . ',' . $detail['unit'] ?>"
                                                        readonly style="text-align:start; font-size: 0.65rem">
                                                    <input class="d-none col table-data w-4r" type="text"
                                                        name="weightage[]" value="<?php echo $detail['weightage'] ?>">
                                                    <input class="d-none col table-data w-4r" type="text" name="unit[]"
                                                        value="<?php echo $detail['unit'] ?>">
                                                </td>

                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')"
                                                    style="text-align:start;">
                                                    <input class="col table-data w-3r" type="text" name="qty[]"
                                                        value="<?php echo $detail['qty'] ?>" readonly
                                                        style="font-size: 0.65rem; text-align: end">
                                                </td>

                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')">
                                                    <input class="col table-data w-3r" type="text" name="freeQty[]"
                                                        value="<?php echo $detail['free_qty'] ?>" readonly
                                                        style="font-size: 0.65rem; text-align: end;">
                                                </td>

                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')">
                                                    <input class="col table-data w-4r" type="text" name="mrp[]"
                                                ...
                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')">
                                                    <input class="col table-data w-4r" type="text" name="ptr[]"
                                                        value="<?php echo $detail['ptr'] ?>" readonly
                                                        style="font-size: 0.65rem; text-align: end;">
                                                </td>

                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')">
                                                    <input class="col table-data w-3r" type="text" name="gst[]"
                                                        value="<?php echo $detail['gst'] ?>%" readonly
                                                        style="font-size:0.65rem; text-align:end">
                                                    <input class="d-none col table-data w-3r" name="gstPerItem[]"
                                                        value="<?php echo $detail['gst_amount'] ?>">
                                                </td>

                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')">
                                                    <input class="d-none col table-data w-4r" type="text" name="base[]"
                                                        value="<?php echo $detail['base'] ?>" readonly
                                                        style="font-size:0.65rem">

                                                    <input class="col table-data w-3r" type="text" name="discount[]"
                                                        value="<?php echo $detail['discount'] ?>%" readonly
                                                        style="font-size:0.65rem; text-align: end;">
                                                ...
                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')">
                                                    <input class="col table-data w-4r" type="text" name="margin[]"
                                                        value="<?php echo $detail['margin'] ?>" readonly
                                                        style="font-size:0.65rem;text-align: end;">
                                                </td>

                                                <td class="p-0 pt-3"
                                                    onclick="customClick('<?php echo 'table-row-' . $slno ?>','<?php echo $detail['product_id'] ?>','<?php echo $detail['distributor_bill'] ?>','<?php echo $detail['batch_no'] ?>')">
                                                    <input class="col table-data w-5r" type="text" name="billAmount[]"
                            ...
                            <div class="m-3 p-3 pt-3 font-weight-bold text-light purchase-items-summary rounded">
                                <div class="row mb-3">
                                    <div class="col-md-3  d-flex justify-content-start">
                                        <p>Distributor :
                                            <input class="d-none summary-inp" name="prev-distributor-id"
                                                id="prev-dist-id" type="text"
                                                value="<?php
                                                if ($edit == TRUE) {
                                                    echo $stockIn[0]['distributor_id'];
                                                    }
                                                    ?>" readonly>
                                            <input class="d-none summary-inp" name="updated-distributor-id"
                                                id="updated-dist-id" type="text"
                                                value="<?php
                                                if ($edit == TRUE) {
                                                    echo $stockIn[0]['distributor_id'];
                                                }
                                            ...
                                            <input class="summary-inp" name="distributor-name" id="distributor-name"
                                                type="text" value="<?= $distName ?>" readonly>
                                        </p>
                                    </div>

                                    <div class="col-md-3 d-flex justify-content-start">
                                        <p>Dist. Bill :
                                            <input class="d-none summary-inp" name="prev-distributor-bill"
                                                id="prev-distributor-bill-no" type="text"
                                    ...
                                    <div class="col-md-3  d-flex justify-content-start">
                                        <p>Due Date :
                                            <input class="summary-inp" name="due-date-val" id="due-date-val" type="text"
                                                value="<?php if ($edit == TRUE) {
                                ...
                                <input class="summary-inp" name="stok-in-data-array" id="stok-in-data-array" type="text"
                                    value="<?php print_r($arrayCheckId) ?>" hidden>

                                <input class="summary-inp" name="stok-in-id" id="stok-in-id" type="number"
                                    value="<?php echo $stockIn_id ?>" hidden>
                            </div>
