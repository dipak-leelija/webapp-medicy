...
<head>
    ...
    <title>Expiry Report - <?= $HEALTHCARENAME ?></title>
...
<body id="page-top">
                    ...
                    <div class="shadow rounded" style="min-height: 70vh;">
                        <div class="row reportNavbar mx-0 rounded d-flex justify-content-start align-items-center">
                            ...
                            <div class="col-md-1 searchFilterDiv" id="search-btn-div">
                                <button type="button" id="search-filter" name="find-report" class="focus-out btn btn-primary btn-sm text-center" onclick="itemExpiryReportSearch()">
                        ...
                        <!-- report table start -->
                        <table class="table" id="expiry-report-table">
    ...
    <script src="<?php echo JS_PATH; ?>expiry-report.js"></script>
</body>
