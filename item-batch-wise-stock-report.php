...
<head>
    ...
    <title>Batch Wise Stock - <?= $HEALTHCARENAME ?></title>
                        ...
                        <div class="row reportNavbar mx-0 rounded d-flex justify-content-start align-items-center">
                            ...
                            <div class="col-md-2 bg-white me-3 selectDiv" id="data-filter-search-div">
                                <div class="input-group">
                                    <input class="focus-out cxv-inp border-0 p-1 w-100" type="text" placeholder="Search Item" name="item-search" id="search-by-item" style="width:10rem;">
